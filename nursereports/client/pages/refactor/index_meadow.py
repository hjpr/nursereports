"""
Meadow variant — sage green & sky blue.
...
def _hero() -> rx.Component:
    return rx.flex(
        ...
        # White blob — light mode only, softens the wiggle texture behind the text
        rx.box(
            class_name=(
        ...
        # Soft emerald glow behind content
        rx.box(
            class_name=(
                "absolute top-1/2 left-1/2 "
...
def _stats_band() -> rx.Component:
    return rx.flex(
        ...
        class_name=(
            ...
            "border-y border-neutral-300 dark:border-neutral-800 "
            "bg-emerald-500/10 dark:bg-emerald-900/15 "
            "backdrop-blur-md"
        ),
    )
...
def _sponsor_logo(_: int) -> rx.Component:
    return rx.box(
        class_name=(
            ...
            "bg-emerald-300/80 dark:bg-emerald-900/40"
        ),
    )
