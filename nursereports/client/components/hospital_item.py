        ...
        rx.flex(
                    ...
                    rx.tooltip(
                        rx.skeleton(
                            rx.button(
                                rx.icon(
                                    "list-plus",
                                    class_name="stroke-zinc-700 dark:stroke-zinc-500",
                                ),
                                ...
                                on_click=UserState.add_hospital_to_user_list(
                                    hospital["hosp_id"]
                                ),
                            ),
                            loading=~rx.State.is_hydrated,
            ...
            rx.cond(
                ...
                rx.flex(
                    ...
                    on_click=ReportState.make_full_report(hospital["hosp_id"]),
                ...
                rx.flex(
                    ...
                    on_click=HospitalState.redirect_to_hospital_overview(
                        hospital["hosp_id"]
                    ),
                    class_name="flex-col items-center justify-center w-16 md:w-24 active:bg-zinc-200 dark:active:bg-zinc-700 transition-colors duration-75 cursor-pointer",
                ),
        ...
        rx.popover.trigger(
            flex(
                rx.skeleton(
                    rx.icon(
                        "trash-2",
                        class_name="h-5 w-5 stroke-zinc-700 dark:stroke-zinc-500",
                    ),
                    loading=~rx.State.is_hydrated,
                ...
                rx.popover.close(
                    flex(
                        rx.button(
                            ...
                            loading=UserState.user_is_loading,
                            on_click=UserState.remove_hospital_from_saved(
                                hospital["hosp_id"]
                            ),
                        ),
                        outline_button(
