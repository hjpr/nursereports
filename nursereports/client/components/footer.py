...
def footer() -> rx.Component:
    return flex(
        ...
        class_name="flex-col items-center justify-start border border-solid border-zinc-100 border-t-zinc-200 dark:border-zinc-900 dark:border-t-zinc-700 py-20 w-full"
    )